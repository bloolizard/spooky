...
# def parseFileName(path): return path.split('/')[-1].split('.')[0]
# categories = list(map(lambda path: parseFileName(path), findFiles('data/names/*.txt')))
#
# print(categories)
#
...
#     category = parseFileName(filename)
